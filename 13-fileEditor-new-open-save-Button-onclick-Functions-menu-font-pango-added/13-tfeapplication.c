#include "13-fileEditor-new-open-save-Button-onclick-Functions-in-TfeTextView-Functions.h"

/*
 Menu:
	File	Edit		View				Quit(close)
	new	cut		Appearance(font, fontstyle, padding, fontfamily,pango)-css.c, css.h,menu.ui
	open	copy
	save	paste
	close	select all
*/
...
/* ----- button handlers ----- */
//REMOVING STATIC FUNCTIONS AS WE ADDED SIGNAL HANDLERS INSTEAD OF SWAPPED FUNCTIONS
...
static void app_startup (GApplication *application) {
  ...
  build = gtk_builder_new_from_file ("13-fileEditor-new-open-save-Button-onclick-Functions-in-TfeTextView-Functions.ui");
  ...
  settings = g_settings_new ("org.gtk.example");
  ...
  build = gtk_builder_new_from_file ("13-menu.ui");
