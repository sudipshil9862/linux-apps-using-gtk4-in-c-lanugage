...
static void color_activated(GSimpleAction *action, GVariant *parameter, gpointer win) {
...
/*  GtkCssProvider *provider = gtk_css_provider_new ();*/
  ...
  gtk_css_provider_load_from_data (provider, "label#lb {background-color: red; color:white;font-family: 'Times New Roman';font-size: 30px;}", -1);
