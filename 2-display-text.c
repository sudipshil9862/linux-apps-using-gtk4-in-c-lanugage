...
static void activate (GtkApplication* app, gpointer user_date){
	...
	label = gtk_label_new("hello, world");
        //now to display the text we need to add this label into window instance using gtk_window_set_child() method. Now as it taked widget as 1st argument so we need to cast the window by GTK_WINDOW as 1st arg should be type of GtkWindow widget. Means 1st arg taked window instance so i'm gonna cast the window variable.
